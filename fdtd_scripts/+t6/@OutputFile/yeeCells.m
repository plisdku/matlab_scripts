...
if strcmp(X.Regions, 'Separate')
    ...
    for rr = 1:length(obj.Regions)
        ii{rr} = obj.Regions{rr}.YeeCells(1):obj.Regions{rr}.YeeCells(4);
        jj{rr} = obj.Regions{rr}.YeeCells(2):obj.Regions{rr}.YeeCells(5);
        kk{rr} = obj.Regions{rr}.YeeCells(3):obj.Regions{rr}.YeeCells(6);
    end
