function addSoftSource(varargin)
%addSoftSource Add a soft electromagnetic field source to the current grid.
%   addSoftSource('Field', 'ez', 'YeeCells', [50 50 50 50 50 50], 'TimeData', ...
...
%   Example:
%
%   addSoftSource('Field', 'ex hx', 'YeeCells', [50 50 50 50 50 50; ...
